...
const translations: Translations = {
  ...
  extensionTitle: { vi: 'PriceHawk Extension', en: 'PriceHawk Extension' },
  ...
  joinPriceHawk: { vi: 'Tham gia cùng PriceHawk', en: 'Join PriceHawk' },
  ...
  heroDesc: { vi: 'PriceHawk tự động theo dõi giá, phân tích lịch sử và cảnh báo khi có deal hời từ Shopee, Lazada, Tiki và hơn thế nữa.', en: 'PriceHawk automatically tracks prices, analyzes history and alerts you when there are great deals from Shopee, Lazada, Tiki and more.' },
  ...
  joinUsersDesc: { vi: 'Gia nhập cùng hơn 50,000 người dùng đang săn deal mỗi ngày với PriceHawk.', en: 'Join over 50,000 users hunting deals every day with PriceHawk.' },
  ...
  sidebarPromoTitle: { vi: 'PriceHawk Pro', en: 'PriceHawk Pro' },
